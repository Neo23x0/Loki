            ...
            for filename in files:
                try:
                    ...
                    if print_filesize_info and args.printall:
                        logger.log("NOTICE", "FileScan", "Skipping file due to file size: %s TYPE: %s SIZE: %s CURRENT SIZE LIMIT(kilobytes): %d" % (fileNameCleaned, fileType, fileSize, fileSizeLimit))
