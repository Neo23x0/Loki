...
rule Anthem_DeepPanda_sl_txt_packed {
	meta:
		description = "Anthem Hack Deep Panda - FBI Liaison Alert System # A-000049-MW - ScanLine sl-txt-packed"
		author = "Florian Roth"
...
rule Anthem_DeepPanda_lot1 {
	meta:
		description = "Anthem Hack Deep Panda - FBI Liaison Alert System # A-000049-MW - lot1.tmp-pwdump"
		author = "Florian Roth"
		reference = "http://krebsonsecurity.com/wp-content/uploads/2015/02/FBI-Flash-Warning-Deep-Panda.pdf"
		date = "2015/02/08"
...
rule Anthem_DeepPanda_htran_exe {
	meta:
		description = "Anthem Hack Deep Panda - FBI Liaison Alert System # A-000049-MW - htran-exe"
		author = "Florian Roth"
		reference = "http://krebsonsecurity.com/wp-content/uploads/2015/02/FBI-Flash-Warning-Deep-Panda.pdf"
		date = "2015/02/08"
